...
const timeline = [
  ...
  {
    year: "2010",
    event: "Premier contrat avec une maison de luxe du groupe LVMH",
  },
  {
    year: "2014",
    event: "Expansion nationale et premiers \u00e9v\u00e9nements internationaux",
  },
  { year: "2017", event: "Cap des 500 \u00e9v\u00e9nements r\u00e9alis\u00e9s" },
  {
    year: "2020",
    event:
      "Adaptation et innovation face aux nouveaux formats \u00e9v\u00e9nementiels",
  },
  {
    year: "2024",
    event:
      "500+ \u00e9v\u00e9nements par an et un r\u00e9seau de 300+ r\u00e9gisseurs d'exception",
  },
];
    ...
    <>
      ...
      <Section>
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="space-y-6 font-outfit text-[14px] text-text-muted font-light leading-[1.9]"
          >
            <p>
        ...
        >
          {values.map((v) => (
            <motion.div
              key={v.title}
              variants={fadeInUp}
              className="p-7 border border-red/[0.08] rounded-[4px]"
            >
              <h3 className="font-playfair text-[19px] text-red font-normal mb-3">
                {v.title}
              </h3>
          ...
          {timeline.map((item) => (
            ...
            >
              <div className="flex-shrink-0 w-16">
                <span className="font-playfair text-xl font-light text-red">
                  {item.year}
                </span>
              </div>
      ...
      <Section variant="dark" className="text-center">
        ...
        >
          <div className="w-20 h-20 rounded-full bg-dark border border-red/15 mx-auto mb-6 flex items-center justify-center">
            <span className="font-playfair text-2xl text-red font-light">
              NN
            </span>
          </div>
          ...
          <p className="font-outfit text-[14px] text-text-muted font-light leading-[1.9] max-w-lg mx-auto mb-10">
            Fort de plus de 18 ans d&apos;exp\u00e9rience dans
            l&apos;\u00e9v\u00e9nementiel haut de gamme et de luxe, Nicola a cr\u00e9\u00e9
            The Next Event avec la vision de professionnaliser le staffing
            \u00e9v\u00e9nementiel \u00e0 Paris et \u00e0 l&apos;international.
          </p>
