              ...
              <div className="flex flex-col items-center justify-center h-full gap-8 pb-20">
                ...
                >
                  <a
                    ...
                    aria-label="Nous appeler"
                    className="flex items-center gap-3 px-5 py-2.5 border border-red/20 rounded-[2px] font-outfit text-[13px] font-medium text-text-muted hover:text-text hover:border-red/40 transition-all duration-300"
                  >
