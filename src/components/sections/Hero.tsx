  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center px-6 max-w-[1000px] mx-auto">
        {/* Badge */}
        <div className="flex items-center justify-center gap-4 mb-10 hero-anim hero-anim-1">
        ...
        {/* H1 */}
        <h1 className="font-playfair text-[clamp(36px,6vw,72px)] font-light text-text leading-[1.1] mb-8 tracking-[-1px] hero-anim hero-anim-2">
          {dict.hero.title1}
          <br />
        ...
        {/* Subtitle */}
        <p className="font-outfit text-text-muted text-base max-w-[600px] mx-auto mb-12 font-light leading-[1.8] hero-anim hero-anim-3">
          {dict.hero.subtitle}
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 hero-anim hero-anim-4">
        ...
        {/* Urgency badge */}
        <div className="mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20 hero-anim hero-anim-5">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 hero-anim hero-anim-6">
